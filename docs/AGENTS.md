...
task status. `RANDOM_WIRE_BROWSER_CHECKS.md` is the by-hand pass, since
nothing automated here opens a browser. Keep findings and design
decisions in the model note and task state in the TODO.
